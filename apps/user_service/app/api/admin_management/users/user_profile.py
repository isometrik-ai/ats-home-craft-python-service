...
async def get_user_profile(
    ...
    #     )
    #     logger.debug(
    #       "Client member profile retrieved from database - Request ID: %s, ",
    #       request_id)
    #     logger.debug("Profile found: %s",user_profile is not None)

    #     if not user_profile:
    #         logger.warning("Client member profile not found - Request ID: %s, ",request_id)
    #         logger.warning(
    #             "User ID: %s, Organization ID: %s",
    #             user_context.user_id,user_context.organization_id
    #         )
    ...
    #         user_context.organization_id,
    #     )
    #     logger.debug("Candidate profile retrieved from database - Request ID: %s, ",request_id)
    #     logger.debug("Profile found: %s",user_profile is not None)
    #     if not user_profile:
    #         logger.warning("Candidate profile not found - Request ID: %s, ",request_id)
    #         logger.warning(
    #             "User ID: %s, Organization ID: %s",
    #             user_context.user_id,user_context.organization_id
    #         )
