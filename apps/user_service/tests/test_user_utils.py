...
class TestCreateUserProfileData:
    ...
    def test_create_user_profile_data_with_verification_preference(self):
    ...
    def test_create_user_profile_data_verification_preference_not_dict(self):
    ...
    def test_create_user_profile_data_verification_preference_none(self):
    ...
    def test_create_user_profile_data_joined_at_not_datetime(self):
    ...
    def test_create_user_profile_data_last_active_at_not_datetime(self):
    ...
    def test_create_user_profile_data_with_role_and_permissions(self):
    ...
    def test_create_user_profile_data_custom_user_type(self):
        """Test user profile with custom user type (user_type parameter is passed but not stored in model)."""
        user_profile = {
            "user_id": str(uuid.uuid4()),
            "email": "test@example.com",
            "full_name": "Test User",
