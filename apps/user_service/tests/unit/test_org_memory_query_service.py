...
def test_dedupe_hits_by_id() -> None:
    ...
    hits = [
        GraphitiSearchHit(id="a", text="one"),
        GraphitiSearchHit(id="a", text="dup"),
        GraphitiSearchHit(id="b", text="two"),
    ]
...
def test_drop_deleted_and_empty() -> None:
    ...
    hits = [
        GraphitiSearchHit(id="1", text="ok"),
        GraphitiSearchHit(id="2", text=""),
        GraphitiSearchHit(id="3", text="gone", metadata={"status": "deleted"}),
    ]
