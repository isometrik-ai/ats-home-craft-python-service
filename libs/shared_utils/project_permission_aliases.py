...
PROJECT_PERMISSION_SATISFIERS: dict[str, frozenset[str]] = {
    ...
    FACILITY_BOOKING_MANAGEMENT_VIEW: frozenset({FACILITY_BOOKING_MANAGEMENT_VIEW}),
    FACILITY_BOOKING_MANAGEMENT_CONFIGURE: frozenset({FACILITY_BOOKING_MANAGEMENT_CONFIGURE}),
    FACILITY_BOOKING_MANAGEMENT_APPROVE: frozenset({FACILITY_BOOKING_MANAGEMENT_APPROVE}),
    FACILITY_BOOKING_MANAGEMENT_OPERATE: frozenset({FACILITY_BOOKING_MANAGEMENT_OPERATE}),
    FACILITY_BOOKING_MANAGEMENT_BILLING: frozenset({FACILITY_BOOKING_MANAGEMENT_BILLING}),
    ...
    VEHICLE_MANAGEMENT_VIEW: frozenset({VEHICLE_MANAGEMENT_VIEW}),
    VEHICLE_MANAGEMENT_EDIT: frozenset({VEHICLE_MANAGEMENT_EDIT}),
    VEHICLE_MANAGEMENT_DELETE: frozenset({VEHICLE_MANAGEMENT_DELETE}),
    ...
    WORK_ORDER_MANAGEMENT_VIEW: frozenset(
        {WORK_ORDER_MANAGEMENT_VIEW, WORK_ORDER_MANAGEMENT_MANAGE}
    ),
    WORK_ORDER_MANAGEMENT_EDIT: frozenset(
        {WORK_ORDER_MANAGEMENT_EDIT, WORK_ORDER_MANAGEMENT_MANAGE}
    ),
    WORK_ORDER_MANAGEMENT_APPROVE: frozenset(
        {WORK_ORDER_MANAGEMENT_APPROVE, WORK_ORDER_MANAGEMENT_MANAGE}
    ),
    WORK_ORDER_MANAGEMENT_PAY: frozenset({WORK_ORDER_MANAGEMENT_PAY, WORK_ORDER_MANAGEMENT_MANAGE}),
    ...
    CONTACTS_MANAGEMENT_EDIT: frozenset({CONTACTS_MANAGEMENT_EDIT}),
...
def org_ceiling_permission_codes(permission_code: str) -> frozenset[str]:
    ...
    if permission_code in {
        ...
        codes.add(WORK_ORDER_MANAGEMENT_VIEW)
        codes.add(WORK_ORDER_MANAGEMENT_EDIT)
        codes.add(WORK_ORDER_MANAGEMENT_APPROVE)
        codes.add(WORK_ORDER_MANAGEMENT_PAY)
