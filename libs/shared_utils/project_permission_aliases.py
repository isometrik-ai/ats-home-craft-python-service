...
PROJECT_PERMISSION_SATISFIERS: dict[str, frozenset[str]] = {
    ...
    WORK_ORDER_MANAGEMENT_VIEW: frozenset({WORK_ORDER_MANAGEMENT_MANAGE}),
    WORK_ORDER_MANAGEMENT_EDIT: frozenset({WORK_ORDER_MANAGEMENT_MANAGE}),
    WORK_ORDER_MANAGEMENT_APPROVE: frozenset({WORK_ORDER_MANAGEMENT_MANAGE}),
    WORK_ORDER_MANAGEMENT_PAY: frozenset({WORK_ORDER_MANAGEMENT_MANAGE}),
