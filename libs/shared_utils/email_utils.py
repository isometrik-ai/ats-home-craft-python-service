...
def send_organization_invitation_email(
    ...
    Args:
        ...
        role (str): Role being offered (owner, admin, member)
...
# def _create_invitation_email_content(
#     organization_name: str,
#     inviter_name: str,
#     invite_url: str,
#     role: str,
...
# ) -> tuple[str, str]:
#     """
#     Create invitation email content (text and HTML).
...
#     """
#     # Plain text content
#     text_content = f"""You're invited to join {organization_name}!
...
# ) -> bool:
#     """
#     Send invitation email using existing email utility.
...
#     try:
#         subject = f"You're invited to join {organization_name}"
#         text_content, html_content = _create_invitation_email_content(
#             organization_name, inviter_name, invite_url, role, expires_at
#         )

#         email_sent = send_email(to_email, subject, text_content, html_content)

#         if email_sent:
#             logger.info("Invitation email sent successfully to %s", to_email)
#             return True
#         else:
#             logger.warning("Failed to send invitation email to %s", to_email)
#             return False

#     except Exception as e:
#         logger.error("Error sending invitation email to %s: %s", to_email, str(e))
#         return False
