...
class DatabaseSettings(BaseSettings):
    ...
    url: str = config("DATABASE_URL", default=None)
    ssl_mode: str = config("DB_SSL_MODE", default="disable")
    ssl_root_cert: str = config("DB_SSL_ROOT_CERT", default=None)
    ...
    statement_timeout_ms: int = config("DB_STATEMENT_TIMEOUT_MS", default=None)
