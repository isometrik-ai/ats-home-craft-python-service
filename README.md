...
FastAPI-based backend for the ATS HomeKraft platform. The repo is organized as a monorepo with the user service under `apps/` and shared libraries in `libs/`.

**Documentation index:** [docs/README.md](docs/README.md)

## Monorepo layout

- `docs/` — top-level documentation index ([docs/README.md](docs/README.md))
- `apps/`
